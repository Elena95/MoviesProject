...
class LocateMapFragment : AppCompatActivity(), Ubication.UbicacionDAOInterface, OnMapReadyCallback {

    private lateinit var map:GoogleMap
    private  lateinit var listLocate: MutableList<LocationModel>
